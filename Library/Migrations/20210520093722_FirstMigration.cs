        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenTitle = table.Column<string>(type: "NVARCHAR", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionTitle = table.Column<string>(type: "NVARCHAR", nullable: false),
                    Salary = table.Column<double>(type: "Float", nullable: false),
                    Duties = table.Column<string>(type: "NVARCHAR", nullable: false),
                    Demands = table.Column<string>(type: "NVARCHAR", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicistTitle = table.Column<string>(type: "NVARCHAR", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "NVARCHAR", nullable: false),
                    Phone = table.Column<string>(type: "NVARCHAR", nullable: false),
                    PassportData = table.Column<string>(type: "NVARCHAR", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookTitle = table.Column<string>(type: "NVARCHAR", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnMark = table.Column<string>(type: "NVARCHAR", nullable: false),
                    EmpID = table.Column<int>(type: "INT", nullable: false),
                    ReadID = table.Column<int>(type: "INT", nullable: false),
                    BookID = table.Column<int>(type: "INT", nullable: false)
                },
